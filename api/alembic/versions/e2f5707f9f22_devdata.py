...
CAT_ELECTRONICS = uuid.UUID('a1000000-0000-0000-0000-000000000001')
CAT_BOOKS       = uuid.UUID('a1000000-0000-0000-0000-000000000002')
CAT_CLOTHING    = uuid.UUID('a1000000-0000-0000-0000-000000000003')

PROD_SMARTPHONE = uuid.UUID('b2000000-0000-0000-0000-000000000001')
PROD_LAPTOP     = uuid.UUID('b2000000-0000-0000-0000-000000000002')
PROD_NOVEL      = uuid.UUID('b2000000-0000-0000-0000-000000000003')
PROD_TEXTBOOK   = uuid.UUID('b2000000-0000-0000-0000-000000000004')
PROD_TSHIRT     = uuid.UUID('b2000000-0000-0000-0000-000000000005')
PROD_JEANS      = uuid.UUID('b2000000-0000-0000-0000-000000000006')

IMG_SMARTPHONE_FRONT = uuid.UUID('c3000000-0000-0000-0000-000000000001')
IMG_SMARTPHONE_BACK  = uuid.UUID('c3000000-0000-0000-0000-000000000002')
IMG_SMARTPHONE_SIDE  = uuid.UUID('c3000000-0000-0000-0000-000000000003')
IMG_LAPTOP_FRONT     = uuid.UUID('c3000000-0000-0000-0000-000000000004')
IMG_LAPTOP_SIDE      = uuid.UUID('c3000000-0000-0000-0000-000000000005')
IMG_NOVEL            = uuid.UUID('c3000000-0000-0000-0000-000000000006')
IMG_TEXTBOOK         = uuid.UUID('c3000000-0000-0000-0000-000000000007')
IMG_TSHIRT_FRONT     = uuid.UUID('c3000000-0000-0000-0000-000000000008')
IMG_TSHIRT_BACK      = uuid.UUID('c3000000-0000-0000-0000-000000000009')
IMG_JEANS_FRONT      = uuid.UUID('c3000000-0000-0000-0000-000000000010')
IMG_JEANS_BACK       = uuid.UUID('c3000000-0000-0000-0000-000000000011')
